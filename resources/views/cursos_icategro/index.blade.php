...
@section('title', 'Cursos ICATEGRO - ICATEGRO')
    ...
    <div class="max-w-7xl mx-auto space-y-8 mt-8">
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div class="p-8">
                ...
                <form action="{{ route('cursos-icategro.store') }}" method="POST">
                    @csrf
        ...
        <div class="bg-white rounded-lg shadow-lg overflow-hidden pb-8">
            ...
            <div class="p-8">
                <div class="overflow-x-auto">
                    <table id="cursosIcategroTable" class="w-full text-sm text-left text-gray-600 stripe hover">
